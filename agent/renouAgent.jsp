...
<head>
    <meta charset="UTF-8">
    <title>Renouvellement d'Assurance - Agent</title>
...
<body>
    ...
    <div class="container">
        <div class="renewal-container">
            <h2 class="page-title">Renouvellement d'Assurance (Agent)</h2>
            
            <!-- Section de recherche -->
            <div class="search-section">
                <h3 class="search-title">Rechercher une assurance</h3>
                <form method="get" action="renouAgent.jsp" class="search-form">
    ...
    <div class="modal" id="renewModal">
        <div class="modal-content">
            ...
            <form action="traitementrenouagent.jsp" method="post">
