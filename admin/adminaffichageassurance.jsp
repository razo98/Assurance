...
<head>
  ...
  <title>Gestion des Assurances - Admin</title>
...
<body>
  <div class="container">
    ...
    <%
      ...
      try {
        ...
        String sqlActive = "SELECT COUNT(*) FROM assurance WHERE valider = 1 and resiliation=0 and suspension=0 AND date_fin >= CURDATE()";
        ...
        String sqlPending = "SELECT COUNT(*) FROM assurance WHERE valider = 0 OR suspension =1 or status = 'En attente'";
        ...
        String sqlExpired = "SELECT COUNT(*) FROM assurance WHERE date_fin < CURDATE() or resiliation =1 ";
          ...
          <%
            ...
            try {
              ...
              String sql = "SELECT a.id_assurance, a.id_voiture, v.marque, a.id_categorie, c.genre, " +
                           ...
                           "a.resiliation, a.suspension, a.valider, a.quartier, a.agents, a.status, a.matricule " +
                           "FROM assurance a " +
              ...
              while(rs.next()) {
                ...
                } else if (dateFin != null && dateFin.before(today)) {
                  statusClass = "status-expired";
                  statusText = "Expirée";
  ...
  <script>
    ...
    function printAssurance(id, marque, client, tel, dateDebut, dateFin, immat, puissance, energie, nbMois, prixTtc, valide, agents, resiliation = 0, suspension = 0) {
      ...
      .then(data => {
        console.log("Données reçues:", data, typeof data);
...
// Vérifier si la chaîne contient "1" (avec ou sans espaces)
  ...
  <!-- Inclure les scripts pour DataTables -->
  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  <script src="https://cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js"></script>
  <script src="https://cdn.datatables.net/1.11.5/js/dataTables.bootstrap5.min.js"></script>
  
  <script>
    // Initialiser DataTables avec traduction française
    $(document).ready(function() {
      ...
      // Après l'initialisation de DataTables, cacher la recherche par défaut et utiliser notre boîte de recherche personnalisée
      $('.dataTables_filter').hide();
      
      // Lier notre champ de recherche personnalisé à DataTables
      $('#searchInput').on('keyup', function() {
        $('#assuranceTable').DataTable().search($(this).val()).draw();
      });
    });
  </script>
</body>
