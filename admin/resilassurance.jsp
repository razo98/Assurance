  ...
  try {
    ...
    img.onload = function() {
      try {
        ...
        setTimeout(function() {
          window.location.href = "adminaffichageassurance.jsp?msg=Résiliée avec succès";
        }, 1000);
        
      } catch(pdfError) {
        console.error("Erreur lors de la génération du PDF:", pdfError);
        alert("Erreur lors de la génération du PDF: " + pdfError.message);
        window.location.href = "adminaffichageassurance.jsp?msg=Erreur génération PDF";
      }
    };
    ...
    img.onerror = function() {
      ...
      try {
        ...
        setTimeout(function() {
          window.location.href = "adminaffichageassurance.jsp?msg=Résiliée avec succès (sans image)";
        }, 1000);
    ...
    window.location.href = "adminaffichageassurance.jsp?msg=Erreur initialisation PDF";
  }
};
</script>
